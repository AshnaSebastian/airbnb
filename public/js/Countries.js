				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'div',
							{ className: 'row' },
							React.createElement(_Rooms2.default, { rooms: country.rooms }),
							React.createElement(
								'div',
								{ className: 'col-md-12' },
								React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										'a',
										{ href: '#', className: 'btn btn-danger btn-lg' },
...
},{"./Gallery":161,"./Rooms":163,"react":159,"react-dom":30}],161:[function(require,module,exports){
'use strict';
...
var Gallery = React.createClass({
	...
	render: function render() {
		...
		var photos = this.props.photos.map(function (photo) {
			...
			return React.createElement(
				'div',
				{ key: photo.id, className: itemClass },
				React.createElement(
					'a',
					{ href: '#' },
					React.createElement('img', { src: photo.path, className: 'img-responsive', alt: '' })
				)
			);
		});
		...
		return React.createElement(
			'div',
			{ id: carousel_id, className: 'carousel slide', 'data-ride': 'carousel' },
			React.createElement(
				'div',
			...
			React.createElement(
				'a',
				{ className: 'left carousel-control', href: carousel_href, role: 'button', 'data-slide': 'prev' },
				React.createElement('span', { className: 'glyphicon glyphicon-chevron-left glyphicon glyphicon-menu-left', 'aria-hidden': 'true' }),
				React.createElement(
					'span',
					{ className: 'sr-only' },
					'Previous'
			...
			React.createElement(
				'a',
				{ className: 'right carousel-control', href: carousel_href, role: 'button', 'data-slide': 'next' },
				React.createElement('span', { className: 'glyphicon glyphicon-chevron-right glyphicon glyphicon-menu-right', 'aria-hidden': 'true' }),
				React.createElement(
					'span',
					{ className: 'sr-only' },
					'Next'
		...
		var rooms = this.props.rooms.map(function (room) {
			while (count++ <= 3) {
				return React.createElement(
					...
					React.createElement(_Room2.default, { room: room })
				);
			}
		});
